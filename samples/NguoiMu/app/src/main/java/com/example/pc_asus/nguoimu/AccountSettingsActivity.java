...
public class AccountSettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Picasso.with(AccountSettingsActivity.this).load(dataSnapshot.child("photoURL").getValue().toString()).into(img_avatar);
                dialog.dismiss();
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {// đáng lí ra là có 3 nút,, chọn ảnh, upload ảnh, lưu , giờ nút lưu thành upload ảnh, khi màn hình đóng(onDestroy) thì mới lưu.
            @Override
            public void onClick(View v) {
    ...
    @Override
    protected void onDestroy() {         // đáng lí ra là có 3 nút,, chọn ảnh, upload ảnh, lưu , giờ nút lưu thành upload ảnh, khi màn hình đóng(ondestroy) thì mới lưu.
        super.onDestroy();
        if(isSave==true){
